...
\def\GLDA{{G^{\rm LDA}}}
\def\WLDA{{W^{\rm LDA}}}
\def\ekn{{\varepsilonUUUUUU{{\bf k}n}}}
\def\phidot{\dot{\phi}}
\def\phidottilde{\dot{\tilde{\phi}}}
\def\phitilde{\tilde{{\phi}}}
\def\epsilonaone{\epsilon^{(1)}UUUUUUa}
\def\epsilonatwo{\epsilon^{(2)}UUUUUUa}
\def\ei{\varepsilonUUUUUUi}
\def\eis{\varepsilonUUUUUU{i\sigma}}
\def\ej{\varepsilonUUUUUUj}
\def\Ekn{{EUUUUUU{{\bf k}n}}}
\def\Psikn{\PsiUUUUUU{{\bf k}n}}
\def\Psiqn{{\PsiUUUUUU{{\bf q}n}}}
\def\Psiqm{{\PsiUUUUUU{{\bf q}m}}}
...
\def\ldagw{{lda{\em GW}}}
\def\ekn{{\varepsilonUUUUUU{{\bf k}n}}}
\def\ekm{{\varepsilonUUUUUU{{\bf k}m}}}
\def\eknp{{\varepsilonUUUUUU{{\bf k}n'}}}
\def\Ekn{{EUUUUUU{{\bf k}n}}}
\def\Psiqkm{{\PsiUUUUUU{{\bf q}-{\bf k}m}}}
\def\Psikn{{\PsiUUUUUU{{\bf k}n}}}
\def\Psikm{{\PsiUUUUUU{{\bf k}m}}}
\def\Psikmstar{{ \PsiUUUUUU{{\bf k}m}^*} }
\def\Psiknp{{\PsiUUUUUU{{\bf k}n'}}}
\def\Psiqnp{{\PsiUUUUUU{{\bf q}n'}}}
\def\Psiqn{{\PsiUUUUUU{{\bf q}n}}}
\def\brl{{\bf R}L}
\def\brlp{{{\bf R}'L'}}
\def\tili{{\widetilde{i}}}
...
\def\tiln{{\widetilde{n}}}
\def\tilm{{\widetilde{m}}}
\def\eak{\varepsilonUUUUUU{\rm a}(\bfk)}
\def\ebk{\varepsilonUUUUUU{\rm b}(\bfk)}
\def\iDelta{{\it \Delta}}
\def\efermi{\mbox{$EUUUUUU{\rm F}$}}
\def\we{\mbox{$\omegaUUUUUU\varepsilon$}}
\def\eal{\varepsilonUUUUUU{al}}
\def\eallo{\varepsilon^{\rm Lo}UUUUUU{al}}
\def\smh{smHankel}
\def\smhs{smHankels}
\def\shotone{OneShot}
...
\def\Re{{\rm Re}}
\def\EMAX{  E^{\rm APW}UUUUUU{\rm MAX} }
\def\EMAXm{ E^{\rm rmesh}UUUUUU{\rm MAX} }
\def\EMAXS{EUUUUUU{\rm MAX}^\Sigma}
\def\NAPW{NUUUUUU{\rm APW}}
\def\RSM{RUUUUUU{\rm SM}}
\def\RSMa{RUUUUUU{{\rm SM},a}}
\def\RSMal{RUUUUUU{{\rm SM},al}}
\def\epsilonal{\epsilonUUUUUU{al}}
\def\RGS{RUUUUUU{\rm G}}
\def\RGSa{RUUUUUU{{\rm G},a}}
\def\pakl{pUUUUUU{akl}}
\def\PakL{PUUUUUU{akL}}
\def\wPakL{\widetilde{P}UUUUUU{akL}}
\def\CakL{CUUUUUU{akL}}
\def\CiakL{C^iUUUUUU{akL}}
\def\EMAX{  E^{\rm APW}UUUUUU{\rm MAX} }
\def\EMAXm{ E^{\rm rmesh}UUUUUU{\rm MAX} }
\def\EMAXvxc{ E^{\rm vxc}UUUUUU{\rm MAX} }
\def\nc{n^{\rm c}}
\def\nzc{n^{\rm Zc}}
\def\nzcv{n^{\rm Zcv}}
...
\def\MM{{\cal M}}
\def\RR{v}
\def\inta{\intUUUUUU{|\bfr|\leq RUUUUUUa}\!\!\!\!\!\!\!\!\!\!\!\!}
\def\intaa{\intUUUUUU{|\bfr|\leq RUUUUUUa}}
\def\intad{\intUUUUUU{|\bfr'|\leq RUUUUUUa}\!\!\!\!\!\!\!\!\!\!\!\!}
\def\intar{\intUUUUUU{|\bfr-\bfRUUUUUUa|\leq RUUUUUUa}}
\def\intard{\intUUUUUU{|\bfr'-\bfRUUUUUUa|\leq RUUUUUUa}}
\def\rhoij{\rhoUUUUUU{ij}}
\def\ekcore{EUUUUUU{\rm k}^{\rm core}}
\def\ek{EUUUUUU{\rm k}}
\def\ehf{EUUUUUU{\rm Harris}}
\def\nin{n^{\rm in}}
\def\nout{n^{\rm out}}
\def\Vin{V}
\def\iDelta{{\it \Delta}}
\def\philo{{\phi}^{\rm Lo}UUUUUU{al}}
\def\DEe{{\it \Delta} EUUUUUU{\rm e}}
\def\ERPA{E^{\rm RPA}}
\def\bfp{{\bf p}}
\def\bfP{{\bf P}}
\def\EMAX{  E^{\rm APW}UUUUUU{\rm MAX} }
...
\newcommand{\innera}[1]{{[\![#1]\!]UUUUUU{RUUUUUUa}}}
...
\newcommand{\CikL}{{C^{(i)}UUUUUU{kL}}}
\newcommand{\CiRkL}{{C^{(i)}UUUUUU{{\bf R}kL}}}
\newcommand{\tPkL}{{\widetilde{P}UUUUUU{kL}}}
\newcommand{\tPRkL}{{\widetilde{P}UUUUUU{{\bf R}kL}}}
\newcommand{\PkL}{{PUUUUUU{kL}}}
\newcommand{\PRkL}{{PUUUUUU{{\bf R}kL}}}
\newcommand{\rmt}{{sUUUUUU{\bf R}}}
\newcommand{\val}{{\rm{VAL}}}
\newcommand{\core}{{\rm{CORE}}}
\newcommand{\xc}{UUUUUU{\rm{xc}}}
\newcommand{\CORE}{{CORE}}
\newcommand{\COREone}{{CORE1}}
\newcommand{\COREtwo}{{CORE2}}
\newcommand{\VAL}{{\rm{VAL}}}
\newcommand{\EF}{EUUUUUU{\rm F}}
...
\newcommand{\bfex}{{\bf e}UUUUUUx}
\newcommand{\bfey}{{\bf e}UUUUUUy}
\newcommand{\bfez}{{\bf e}UUUUUUz}
\newcommand{\bfa}{{\bf a}}
\newcommand{\bfb}{{\bf b}}
\newcommand{\bfS}{{\bf S}}
...
\cite{kotani2015pmt} and \cite{kotaniUUUUUUquasiparticleUUUUUU2014}
...
%\input{ecaljmanualUUUUUUpart1.tex}
...
structure calculations \cite{diUUUUUUvalentinUUUUUUquasiparticleUUUUUU2014}.
...
%at \url{https://www.zotero.org/groups/takaokotaniUUUUUUpaper/items/}\\
...
%to make a driver for other LDA codes ({\sf gwinput\UUUUUUv2.f} 
%is a key rouitne to readin the eigenfunctions and eigenvalues).\\

\noindent {\bf Many-body part (GW part)}, based on \cite{kotaniUUUUUUquasiparticleUUUUUU2014}\\
...
See Eq.(17) of \cite{kotaniUUUUUUquasiparticleUUUUUU2014}.
...
See Sec.3 of \cite{kotaniUUUUUUquasiparticleUUUUUU2014}.
...
beyond current limitation of such GW and LDA/GGA \cite{diUUUUUUvalentinUUUUUUquasiparticleUUUUUU2014}.
...
we determine not only $GUUUUUU0$ but also $W$  (the screened Coulomb
...
% non-interacting spin susceptibility $\chiUUUUUU0^{+-}$, and so on.
...
Lower case, number, and underscore \io{[a-z0-9\UUUUUU]} are allowed.)
...
\item 
  ...
  \verb@mpirun -np 4 lmf-MPIK --mkprocar --band:fn=syml mgo@ gives PROCAR \\
   (Try an example \io{~/ecalj/MATERIALS/MgO\UUUUUUPROCAR/}. 
    Run \exe{./job} at the directory).
\item \exe{gwsc}\\
     QSGW calculation
\item \verb@jobUUUUUUband,jobUUUUUUtdos,jobUUUUUUpdos@\\
     band, fermi surface, tdos, pdos plot.

 \item \verb@jobUUUUUUfermisurface@\\
      Run \verb@jobUUUUUUfermisurface cu -np 4 10 10 10@.
      ...
      With --allband added for \verb@jobUUUUUUfermisurface@, we can write all the
      bands. So, we need this option if you like to write iso-energy
      surface at high (or low) energy.     
\item \exe{epsPP\UUUUUUlmfh}\\
     Dielectric funciton without local field correction (LFC).
\item \exe{eps\UUUUUUlmfh}\\
     Dielectric funciton with LFC
\item \exe{epsPP\UUUUUUlmfh\UUUUUUchipm}\\
      Non-interacting transverse spin polarization.
\item \exe{gw\UUUUUUlmfh}\\ One-shot GW calculation. 
       This also show life-time of QPs (\io{QPU\UUUUUUlmf}).
...
In the following, \verb@si:gwUUUUUUlmfh@ means '$>$\verb@make siUUUUUUgwUUUUUUlmfh@'
at \verb@ecalj/TestInstall/@; this test is performed with the Makefile
at the directory. 
\begin{verbatim}
si:gwUUUUUUlmfh/              Results: QPU 
si:gwsc/                        : QPU,log.si
gas:gwsc/                       : QPU,log.gas
nio:gwsc/                       : QPU,log.nio
feUUUUUUepsPPUUUUUUlmfhUUUUUUchipm:            : ChiPM* 
gas:epsUUUUUUlmfh/                   : EPS*
gas:epsPPUUUUUUlmfh/                 : EPS*
\end{verbatim}
...
├── lm7K/       ! PMT method 
├── MATERIALS/  !jobUUUUUUmaterials.py contains examples. 
...
Ref.\cite{diUUUUUUvalentinUUUUUUquasiparticleUUUUUU2014}.
...
\begin{eqnarray}
(i \frac{\partial }{\partial t} - HUUUUUU0) \psi(\bfr,t)=0 \label{sch0}
\end{eqnarray}
Here $HUUUUUU0$ is the 
one-particle Hamiltonian which contains electrostatic potential
plus exchange-correlation potential $VUUUUUU{\rm xc}$
...
the operator $(i \frac{\partial }{\partial t} - HUUUUUU0)$.
...
$G=1/(i \frac{\partial }{\partial t} -HUUUUUU0)=1/(\omega -HUUUUUU0)$.
...
(\Sigma(\bfr,\bfr',t-t')-VUUUUUU{\rm xc})\right) G
= \delta(t-t')\delta(\bfr-\bfr'). \label{gdef}
\end{eqnarray}
Only the difference is adding 
$\Sigma(\bfr,\bfr',t-t')-VUUUUUU{\rm xc}$.
...
$X(\bfrUUUUUU1 tUUUUUU1, \bfrUUUUUU2 tUUUUUU2, \bfrUUUUUU3 tUUUUUU3)$ directly in the $GW$
calculations.
...
$VUUUUUU{\rm xc}(\bfr,\bfr')$ since it is included in $HUUUUUU0$.
Thus this division is not meaningful if we can solve a problem completely.
However, what we can do is only the perturbation.
Quantities for $HUUUUUU0$ is taken as the basic quantities. On it, we apply the perturbation.
Equivalently we can have a division $H=HUUUUUU0+(H+HUUUUUU0)$, where $H$ is the
many-body Hamiltonian. 

In priniple, we can start from any $VUUUUUU{\rm xc}$. However,
as long as we use perturbation theory, we have to minimize 
the effect of $\Sigma(\bfr,\bfr',t-t')-VUUUUUU{\rm xc}$.
The degree of freedom of the choice of $VUUUUUU{\rm xc}$ is used 
to minimize it. This is the self-consistent pertubation theory idea for QSGW.\\

If $\Sigma(\bfr,\bfr',t-t')-VUUUUUU{\rm xc}$ 
give small effect, we can use the concept of the QP
(independent particle picture) as the basis to evaluate physical
quantities.

We have to determine best (or optimum) $VUUUUUU{\rm xc}$. How to do it?
An idea is that we should determine it so that 
the size of $\Sigma(\bfr,\bfr',t-t')-VUUUUUU{\rm xc}$ should be smallest 
(how to measure the size?).
Or, based on the Landau-Silin's theory, 
the QPs contained in $G$ should be reproduced by $HUUUUUU0$.
In anyway, this ends up with the self-consitent petrurbation theory.
For trial $VUUUUUU{\rm xc}$ (and electron density), we have $HUUUUUU0$; from $HUUUUUU0$
we can calculate $\Sigma(\bfr,\bfr',t-t')$. Then we have to
determine new $VUUUUUU{\rm xc}$ in a method. This is repeated until converged.
...
and now we usually use a standard procedure as described in Ref.
 \cite{kotaniUUUUUUquasiparticleUUUUUU2014}.
%In either way, we somehow need to downfold many-body effect into $VUUUUUU{\rm xc}$.
...
\item Post processing.\\
      ...
      We can use scripts \exe{job\UUUUUUband} for 
      band plot (need \io{syml.si} file (symmetry line for band plot)).
      We also have \exe{job\UUUUUUpdos, job\UUUUUUtdos, job\UUUUUUfermi} and so on for
...
In cases, we specify such subtokens as SITE\UUUUUUATOM\UUUUUUPOS.
...
generate \verb+POSCARUUUUUUcu.vasp+ first, then send it to VESTA.
\verb+viewvesta+ also accept \verb+POSCARUUUUUUcu.vasp+ directly.
...
A tool \verb+vasp2ctrl+ converts POSCAR\UUUUUU\*.vasp to ctrls.\*.
...
re to specify number of magnetic moments ($\muUUUUUUB$) for s,p,d,f channels (difference of up -
...
It is possible to add \verb+RELAX= 0 0 1+ after \verb+SITEUUUUUUATOMUUUUUUPOS+;
...
\begin{verbatim}
conf:SPECUUUUUUATOM= Ga : --- Table for atomic configuration ---
...
conf:-----------------------------------------------------
conf:SPECUUUUUUATOM= As : --- Table for atomic configuration ---
conf:  isp  l  int(P) int(P)z    Qval     Qcore   CoreConf
conf:    1  0       4  0         2.000    6.000 => 1,2,3,
...
given by \verb+ITERUUUUUUNIT=30+ in \verb+ctrl.cu+).
...
We have scripts
\begin{verbatim}
    jobUUUUUUtdos, jobUUUUUUband, jobUUUUUUpdos
\end{verbatim}
. Look into these scripts, and then you see how to plot them.

For total DOS plot, it is better to check ctrl file;
\verb+BZUUUUUUTETRA=1+(this is default; thus make sure that \verb+BZUUUUUUTETRA+ do
not exist or \verb+BZUUUUUUTETRA=1+). 
...
Please look into \io{job\UUUUUUtdos} file in your bin directory. It is a small script.
...
move top one a little). The command \verb+jobUUUUUUpdos+ is a little 
...
However, job\UUUUUUtdos and so on, do not yet accept these options.
...
=== Materials in Materials.ctrls.database are:===
  ...
  CdO  CdS  CdSe  CdTe  Ce  Cu  Fe  GaAs  GaAsUUUUUUso  GaN
...
and run them automatically by a command \verb+./jobUUUUUUmaterials.py+ below.
...
The command \verb+./jobUUUUUUmaterials.py+ gives ctrls.* for these materials
...
Try \verb+./jobUUUUUUmaterials.py Fe --noexec+. (not fe but Fe as it shown above)
...
As for NiO and Fe, we see that \verb+./jobUUUUUUmaterials.py+ gives
SPEC\UUUUUUATOM\UUUUUUMMOM in generated ctrls and ctrl files.
(Look into ctrls.fe; we need SPEC section when we add MMOM.)

Try \verb+jobUUUUUUmaterials.py GaAs Si+.\\
...
``\verb+./jobUUUUUUmaterials --all --noexec+'' generates ctrls and ctrl files of
these materials. ``\verb+./jobUUUUUUmaterials --all+'' do self-consistent
...
help of \verb+./jobUUUUUUmaterials+ (type this without arguments).\\

To make band plot and so on for Fe, follow instructions already explained.
\begin{verbatim}
  $ ./jobUUUUUUmaterials.py Fe  (and need to type return)
  (If you like start over, remove Fe/ under it first).
  $ cd Fe
  $ ./jobUUUUUUmaterials.py fe
  ...
  $ jobUUUUUUband fe -np 4 
	    ...
	    some time)       
  $ jobUUUUUUtdos fe
  $ jobUUUUUUpdos fe (as I said, this supress space-group symmetry, thus time consuming).
\end{verbatim}
At the end of \verb+jobUUUUUUpdos+, we show a help which pdos data is where
...
After doing \verb+./jobUUUUUUmaterials+ foobar, you may like move it back to
...
in ctrl.gas. 
Then run
>lmf gas >& llmfUUUUUUSO
You can see "band gap with SO" by 
> grep gap llmfUUUUUUSO.
...
for the case without SO. (Look into the shell script jobUUUUUUband.
...
plot). See \verb@ecalj/MATERIALS/MgOUUUUUUPROCAR/README@, May19.2014


\subsection{efermi.lmf}
This is generated by lmf(lmf-MPI), which is used in the job\UUUUUUband.


\subsection{Effective mass calculation}
\begin{verbatim}
New band plot and effective mass calculation (curvature):
(see sample at ecalj/MATERIALS/massUUUUUUfitUUUUUUtest/ and its README).
------------
We now read syml.* in lm7K/fp/bndfp.F. Thus jobUUUUUUband is changed
(nspin=1 or nspin=2 is automatically choosed by jobUUUUUUband command).
...
Let us use this example for GaA and run jobUUUUUUband.
(e.g., jobUUUUUUband gaas -np 2 -vnspin=2 -vso=1; 
...
We have an example is at ~/ecalj/MATERIALS/massUUUUUUfitUUUUUUtest
...
We can generate density and $\sumUUUUUU{n} |\Psikn(\bfr)|^2$
...
\noindent{\bf Step.(1)}\\
For the point (1), we have a new line in SPEC\UUUUUUATOM sections.
In ecalj/MATERIALS/erasldau, it is 
\begin{verbatim}
       IDU= 0 0 2 2 UH= 0 0 0.1 0.632 JH= 0 0 0 0.055
\end{verbatim}
The SPEC\UUUUUUATOM\UUUUUUIDU token tells lmf that no U is to be added to the s or
...
To run with spin-orbit coupling, set HAM\UUUUUUSO=1, then run
...
\verb@$echoUUUUUUrun echo == $ix 'iteration over=='@ in gwsc). 
...
We modified \verb@lm7K/subs/mUUUUUUrdctrl.F@(feb2019), so that
...
Then difference $V^{\rm xc}(\bfr,\bfr')V-VUUUUUU{\rm xc}^{\rm
...
$\SigmaUUUUUU{\rm QSGW}-VUUUUUU{\rm xc}^{\rm LDA}$. 
...
if we have \io{HAM\UUUUUURDSIG=12} in \io{ctrl.*}.
Thus this means that
we replace $VUUUUUU{\rm xc}^{\rm LDA}(\bfr)\delta(\bfr-\bfr')$ 
...
(It means that we start from the one-body Hamiltonian $HUUUUUU0$ in LDA/GGA as initial condition.In cases, LDA/GGA give poor initial conditions for QSGW; in such a case,
...
\item[Step 2.]\underline{Run the script \exe{mkGWIN\UUUUUUlmf2}.}
...
A template \verb+GWinput+ can be generated by a script \verb+mkGWINUUUUUUlmf2+. 
...
No sigm ---> LDA caculation for eigenfunctions 
        Start  mpirun -np 2 /home/takao/ecalj/TestInstall/bin/lmf-MPIK  si > llmfUUUUUUlda 
...
OK! --> Start  echo 0|/home/takao/ecalj/TestInstall/bin/rdata4gwUUUUUUv2  > lrdata4gwUUUUUUv2 
...
OK! --> Start  echo 3| mpirun -np 2 /home/takao/ecalj/TestInstall/bin/hsfp0UUUUUUsc > lsxC 
...
OK! --> Start  echo 1|  mpirun -np 2 /home/takao/ecalj/TestInstall/bin/hsfp0UUUUUUsc > lsx 
OK! --> Start  echo 11|  mpirun -np 2 /home/takao/ecalj/TestInstall/bin/hx0fp0UUUUUUsc > lx0 
OK! --> Start  echo 2|  mpirun -np 2 /home/takao/ecalj/TestInstall/bin/hsfp0UUUUUUsc  > lsc 
OK! --> Start  echo 0|  /home/takao/ecalj/TestInstall/bin/hqpeUUUUUUsc  > lqpe 
OK! --> == 0 iteration over ==
OK! --> Start  mpirun -np 2 /home/takao/ecalj/TestInstall/bin/lmf-MPIK  si > llmfUUUUUUgwscend.0 
...
$\rangle \psi(\bfq,n)|\sigmaUUUUUU{\rm c}(\omega) |\psi(\bfq,n)\langle$.
...
(A) Set q point set 
  ...
  *** q-points, which shoud be in qbz.,See KPNTin1BZ.
  ...
  ----------
   To know allowed q points on regular mesh point, run the command "mkGWINUUUUUUlmf2", then
...
\begin{verbatim}
  ...
  can give a plot for Re (SigmaUUUUUUc(omega)) and Im(SigmaUUUUUUc).
...
The purpose of the GW part is to calculate $\SigmaUUUUUU{\rm QSGW}-VUUUUUU{\rm xc}^{\rm LDA}$.}
\label{gwscpicture}
\end{figure}
...
It uses \io{run\UUUUUUarg}, which is a special
...
No sigm ---> LDA caculation for eigenfunctions 
OK! --> Start echo --- | mpirun -np 24 /home/binx/lmf-MPIK gaas > llmfUUUUUUlda 
...
OK! --> Start echo 0 | /home/binx/rdata4gwUUUUUUv2  > lrdata4gwUUUUUUv2 
...
OK! --> Start echo 3 | mpirun -np 24 /home/binx/hsfp0UUUUUUsc  > lsxC 
OK! --> Start echo 0 | /home/binx/hbasfp0  > lbas 
OK! --> Start echo 0 | mpirun -np 24 /home/binx/hvccfp0  > lvcc 
OK! --> Start echo 1 | mpirun -np 24 /home/binx/hsfp0UUUUUUsc  > lsx 
OK! --> Start echo 11 | mpirun -np 24 /home/binx/hx0fp0UUUUUUsc  > lx0 
OK! --> Start echo 2 | mpirun -np 24 /home/binx/hsfp0UUUUUUsc  > lsc 
OK! --> Start echo 0 | /home/binx/hqpeUUUUUUsc  > lqpe 
OK! --> Start echo --- | mpirun -np 24 /home/binx/lmf-MPIK gaas > llmfUUUUUUoneshot 
...
%by handbefore you execute {\bf gw\UUUUUUlmfh}. See next section for it.
%(this function now works only for the case that 
%a symmetry operation is [a translation verctor with spin inversion].)

%Unix shell scripts {\bf gw\UUUUUUlmf} in the {\tt ecal/fpgw/exec} directory
%makes the procedure almost automatic.
%{\bf gw\UUUUUUlmf} is for the \GW calculation including cores.
%{\bf gwnc\UUUUUU{\it foo}} is for the \GW calculation without core.
%{\it foo} donotes the LDA method;we now have 
%implimented {\bf gw\UUUUUUnfp}, {\bf gwnc\UUUUUUnfp}, and {\bf gw\UUUUUUlmf}.
...
\item{\bf echo 1 $|$qg4gw }: Get ${\bf k}$ points used
  ...
  Remember that cutoff of ${\bf G}$ is given by QpGcut\UUUUUUpsi and QpGcut\UUUUUUcou
  in \io{GWinput}. (Based on the experiences, we use smaller QpGcut\UUUUUUcou
...
\item{\bf echo 1 $|$ lmfgw-MPIK} : 
 ...
 $\langle \psi | V^{\rm LDA}UUUUUU{\rm xc}| \psi \rangle$
 at the irreducible ${\bf k}$ points (shown at the bottom of output
     \io{lqg4gw} of \exe{qg4gw}.)
\item{\bf lmf2gw}: store these data into {\sf DATA4GW\UUUUUUV2} and {\sf CphiGeig}, 
whose I/O is controlled by a key subroutine {\bf gwinput\UUUUUUv2.f}.
\end{itemize}

\subsection{\bf Main stage of \exe{gwsc}}
\label{mainstage}
We can start the main stage of \GW calculation from these files;\\
\verb@GWinput DATA4GWUUUUUUV2 CphiGeig QGpsi QGcou Q0P QIBZ SYMOPS BZDATA HAMindex CLASS@;\\
\noindent these files contains eigenfunctions and so on in the manner 
of Eq.(17) of \cite{kotaniUUUUUUquasiparticleUUUUUU2014}, eigenvalues and other required
...
\fl{DATA4GW\UUUUUUV2} Crystal structures and so.
...
(See the top of \io{subroutine write\UUUUUUhamindex} in \io{lm7K/subs/m\UUUUUUhamindex.F}. 
This is also in \io{fpgw/gwsrc/m\UUUUUUhamindex.F}. Identical files are in two
...
\begin{itemize}
\item{\bf rdata4gw\UUUUUUV2}: 
  Read {\sf DATA4GW\UUUUUUV2} and so on, and decompose it into files required
...
\item{\bf echo 3$|$hsfp0\UUUUUUsc  }: gives the Core exchange part of the
...
\item{\bf echo 1$|$hsfp0\UUUUUUsc  }: gives the exchange part of the self-energy.
\item{\bf echo 11$|$hx0fp0\UUUUUUsc }: gives the correlated part of the screened Coulomb interaction $W-v$.
\item{\bf echo 2$|$hsfp0\UUUUUUsc  }: gives the correlated part of the self-energy.
\item{\bf echo 0$|$hqpe\UUUUUUsc}: gather data and write down final results
...
In addition to {\bf gw\UUUUUUlmfh}, there are some other additional scripts 
and functions.

\begin{itemize}
\item
{\bf gw\UUUUUUlmfh} : The one-shot \GW calculation. 
...
\item
{\bf \ epsPP\UUUUUUlmfh, eps\UUUUUUlmfh} : Dielectric function without or with local-field effects.
...
%\item
%{\bf gwband\UUUUUUlmf} : for plotting band (not well maintained now).

\item
{\bf epsPP\UUUUUUlmfh\UUUUUUchipm} : non-interacting spin susceptibility. 
One-degree of freedom like Rigid moment approx.
After it ends, you need to do \verb@caljUUUUUUnlfcUUUUUUmetal@ and/or \verb@caljUUUUUUsummaryUUUUUUmat@
...
% \begin{itemize}
% \item
% {\bf extest, \ extest\UUUUUUrepeat}: 
% which is in order to check the dependence of $\SigmaUUUUUU{\rm x}$ as for $EUUUUUU{\rm smear}$.

% {\bf gw\UUUUUUlmf} : The one-shot \GW calculation, older version. \\
% (Direct calculation of the polarization function
% without going through the Hilbert-transformation.

% \item
% {\bf \ eps\UUUUUUlmf}   : Dielectric function with local-field effects. 
% Direct mode(Not Hilbert-transformation).

% \item
% {\bf gwpara\UUUUUUlmf} : A test gw script for parallel computing (testing. it may not work now).

% \item
% {\bf eps\UUUUUUlmfh\UUUUUUchipm} : spin susceptibility (full mixed basis). Test purpose.
% \end{itemize}
...
1.Bandplot for FSMOMMETHOD/=0 
  ...
  you need to set FSMOMMETHOD=0 (or comment it out) when you run jobUUUUUUbandUUUUUUnspin2.
  [If you run jobUUUUUUbandUUUUUUnspin2 with FSMOMMETHOD/=0, it make a shift 
...
2.Note that ctrlgenM1.py automatically set this for --systype=molecule.
   ...
   In addiiton, FSMOM (nUUUUUUup-nUUUUUUdown) is needed (FSMOMMETHOD=1)if we
...
5. Back ground charge and fractional Z.
   You can use fractional numbers for ATOMUUUUUUZ, and also can set
   valence charge by BZUUUUUUZBAK (I removed BZUUUUUUVAL).
   ...
   . This is a case with BZUUUUUUZBAK=.2.
...
9. ERROR EXIT! rgwina: 2nd wrong l valence
   ...
   Back it up. And run mkGWINUUUUUUlmf2 (any n1 n2 n3 is fine).
...
\item == Do we use VWN or GGA for QSGW? ===\\
  ...
  In anyway, use VWN (HAM\UUUUUUXCFUN=1) as standard.
...
\begin{verbatim}
 ...
 Exit -1 zhevUUUUUUtk2: nev /=nevx something wrong.
\end{verbatim}
...
basis. For example, one in the set \{$fUUUUUU1, fUUUUUU2, ..., fUUUUUUn$\} would 
be almost give by a linear-combination of others. We need to make the
      ...
      $\langle  fUUUUUUi|fUUUUUUj \rangle$. We do diagonalization, then 
...
lcutmx(atom) = maximum l-cutoff for the product basis.
  4  4  4  2  2  4  4
\end{verbatim}
For $\phiUUUUUU1 \times \phiUUUUUU2$ case, $|lUUUUUU1 - lUUUUUU2| \le lUUUUUU{tot} \le |lUUUUUU1 + lUUUUUU2|$. So `lcutmx' changes the maximum cutoff for the l$UUUUUU{tot}$. The order is the same as the order of atoms in the {\bf ctrl} file.
...
`occ' and `unocc` mean that we use only ones that checked as `1', in other words we neglects `0' cases for making product basis. Be careful for confusion with name `occ' and `unocc'. These don't mean that occupied or unocc. When making product basis, $M = \phiUUUUUU1 \times \phiUUUUUU2$, `occ' corresponds to $\phiUUUUUU1$ and `unocc' to $\phiUUUUUU2$. For example, 
\begin{verbatim}
  atom   l    n  occ unocc  ! Valence(1=yes,0=no)
    1    0    1    1    1   ! 5SUUUUUUp  -----
    2    3    1    0    1   ! 4fUUUUUUp
\end{verbatim}
If the options are like the above, the product basis will be consists of ($\phiUUUUUU1 = \phiUUUUUU{atom=1,l=0}) \times (\phiUUUUUU2 = \phiUUUUUU{atom=1,l=0})$, ($\phiUUUUUU{atom=1,l=0} \times \phiUUUUUU{atom=2,l=3}$). As you can see, ($\phiUUUUUU1 = \phiUUUUUU{atom=2,l=3}$) is skipped.\\
...
== QSGW for Fe.
  ...
  I also got aware that emaxUUUUUUsigm should be large enough (4$\sim$5 Ry) 
...
Try to run examples in \verb@ecalj/MATERIALS/SampleUUUUUUMLWF/@.
Read \verb@README@ in it.
To run the script \exe{genMLWF}, we need to get \verb@GWinput@
by editing \verb@GWinput.tmp@. (\verb@mkGWinUUUUUUlmf2@ contains default Wannier section).
...
5 is the number of Wannier function. The most left one means $\phi$ index and the right one of it is $\dot\phi$ index. They are written in the {\bf @MNLA\UUUUUUCPHI} file.
...
\verb+visUUUUUUwanUUUUUU*+ options.)
...
\verb+IO+ as \verb+IOUUUUUUVERBOSE+.


\begin{itemize}
\item
\verb+IOUUUUUUTIM+ is for debugging. It shows which subroutines are
...
These are defined subtokens under SPEC\UUUUUUATOM=foobar (we have multiple SPEC\UUUUUUATOM=foobar).

Then we place these MTs at SITE sections in the cell.
At SITE, we specify atomic sites 
(What SPEC\UUUUUUATOM is placed to positions by POS) in a primitive cell.
We set \verb+POS=+ by direct form (Cartesian) but with the unit of \verb$ALAT+DLAT$.
Total number of SITE (number of tokens SITE\UUUUUUATOM) is
the number of atoms in the primitive cell.
Setting \verb+POS=+ under  SITE\UUUUUUATOM=foobar 
means that we place MT named as foobar defined in SPEC\UUUUUUATOM=foobar.
%We set subtoken SITE\UUUUUUATOM\UUUUUUPOS under SITE\UUUUUUATOM, to specify atomic positions.
In addition, we can set SITE\UUUUUUATOM\UUUUUURELAX, if you like to find relaxed
structure (we simultaneously set DYN category) in LDA. As for
relaxation, see \verb+LaGaOUUUUUUrelax/ctrl.lagao+
example, and read DYN in Document/Manual/CategoryAndToken.org.

The SITE\UUUUUUATOM=foobar (with same foobar with different POS) are not
...
Thus \verb+SITEUUUUUUATOM=foobar+ are divided into ``classes'' which are
...
A sample is \verb+lmchk lagao+ at \verb+~/ecalj/lm7K/TESTsamples/LaGaOUUUUUUrelax+
...
We have some \verb+SPECUUUUUUATOM+, 
under which we give subtokens such as
\verb+SPECUUUUUUATOMUUUUUUR+(MT radius), \verb+SPECUUUUUUATOMUUUUUUZ+(nucleus charge), 
cutoff parameters of angular momentum, and so on. 
These \verb+SPECUUUUUUATOM+ is refereed to in SITE.
...
\verb+SPECUUUUUUATOMUUUUUUZ+,\verb+SPECUUUUUUATOMUUUUUUR+, and so on.

Subtokens Z= is the nucleus charge and R= MT radius.
Note that Fe is just a name to distinguish MT sphere in the cell.
If you set SPEC\UUUUUUATOM\UUUUUUZ=27, it is recognized as Co (since Z=27). 
...
MMOM=s,p,d,f... gives initial condition of magnetic moment in $\muUUUUUUB$
...
two NiO in a primitive cell. Thus it is reasonable to have two SPEC\UUUUUUATOM
as Ni1 and Ni2, although subtokens under
ATOM=Ni1 and ATOM=Ni2 (e.g. \verb+SPECUUUUUUATOMUUUUUUEH+ for them) are the same
except initial condition of magnetic moment of MMOM=s,p,d,f...
See example of NiO.
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
The minimum help of call Category\UUUUUUtoken\UUUUUUsubtoken are listed with
...
(See also STRUC\UUUUUUPLAT, and so on).
...
%It lists all Category\UUUUUUToken\UUUUUUSubtoken; but it maybe too much for beginners.

\begin{quote}
For QSGW calculation:

We need a setting in ctrl file to read sigm file (HAM\UUUUUUSIGP). 
...
where EMAX is a little (0.5Ry) less than \verb+emaxUUUUUUsigm+. If something
...
\begin{verbatim}
  ...
  We have to set SPECUUUUUUATOMUUUUUUPZ=?,?,? 
...
A template {\sf GWinput.tmp} is generated by \exe{mkGWIN\UUUUUUlmf2}. 
Required files are
...
(Recently modified \exe{mkGWIN\UUUUUUlmf2} runs \exe{lmfa} internally.
...
\vspace{3mm}
When you run {\bf mkGWIN\UUUUUUlmf}, 
...
We need to repeat mkGWIN\UUUUUUlmf2
...
%[it is a unified file of old {\sf GWIN0},  {\sf GWIN\UUUUUUV2}, and {\sf QPNT}].
...
specified by \verb@<PRODUCTUUUUUUBASIS>@, 
\verb@<QPNT>@,  \verb@<PBASMAX>@, \verb@<QforEPS>@, and \verb@<QforEPSL>@.
(\verb@<PRODUCTUUUUUUBASIS>@ is requires for all kinds of calculations.
...
(test routine is \verb@main/kinoUUUUUUinputUUUUUUtest.F@.)

Soche the {\sf GWinput} consists of three sections \\
\begin{enumerate}
 \item General section 
 \item \verb@<PRODUCTUUUUUUBASIS>@ section
...
QpGcutUUUUUUpsi    4.000 !(See unitUUUUUU2pioa for unit) |q+G| cutoff for eigenfunction.
QpGcutUUUUUUcou    3.000 !(See unitUUUUUU2pioa for unit) |q+G| cutoff for Coulomb and W.
unitUUUUUU2pioa off ! off --> a.u.; on--> unit of QpGcutUUUUUU* are in 2*pi/alat 
alphaUUUUUUOffG    1.000 !(a.u.) Used in auxially function in the offset-Gamma method.
!emaxUUUUUUchi0   99999.000 !(Ry) emax cutoff for chi0  (Optional)
emaxUUUUUUsigm       3.000 !(Ry)  emax cutoff for Sigma

! ##### FREQUENCIES from GWINUUUUUUV2 ################ 
dw      0.005000 !(a.u.) energy-mesh (bin width size) along real axis.
omgUUUUUUc      0.040 !(a.u.) energy-mesh is twiced at omgUUUUUUc
  !  coaser mesh for higher energy. Width get to be doubled at omgUUUUUUc.
iSigMode     3 ! QSGW mode switch for gwsc. use =3.
niw         10 ! Number of frequencies along Im axis. Used for integration to get SigmaUUUUUUc
...
\begin{enumerate}
\item BZ integration.\\
\keyw{n1n2n3} 3 integers as $NUUUUUU1,NUUUUUU2,N3$ (no default); They are $\ge 0$. \\
...
for $G \times W$. But not that Chi\UUUUUURegQbz below allow you to use
...
\keyw{Chi\UUUUUURegQbz} (on or off)

Chi\UUUUUURegQbz = on (default): Use regular mesh (including gamma) for eps calculation.

Chi\UUUUUURegQbz = off : Use off-Gamma mesh (Not including gamma) for eps calculation.

(In cases, {\tt Chi\UUUUUURegQbz off} gives faster convergence as for {\tt n1n2n3};
 not only for GW, but also for dielectric functions \exe{eps\UUUUUUlmfh}.)
% \keyw{BZmesh} (1 or 2)
...
%      (Chi\UUUUUURegQbz x BZmesh). 
%      I think that BZmesh 2 is now not good for self-consistent GW.

\item 
Plane wave (${\bf q+G}$) cutoff  \\
\keyw{QpGcut\UUUUUUpsi} 1 real (no default)\\
\keyw{QpGcut\UUUUUUCou} 1 real (no default)\\
\keyw{unit\UUUUUU2pioa} 1 logical (no defalt)\\
We have two cutoff for ${\bf q+G}$.
{\tt QpGcut\UUUUUUpsi} is the cutoff of $|q+G|$ for the IPW 
in the expansion of the eigenfunctions.
{\tt QpGcut\UUUUUUCou} is for the IPW of the interactions $v,D,W$.
Its unit is specified by {\tt unit\UUUUUU2pioa };
"off" means unit in a.u. and "on" means in unit of $\frac{2 \pi}{\mbox{\rm alat}}$.
(alat is length scale unit in {\sf ctrl.*}).\\

Rule of thumb:
     \verb+QGcutUUUUUUpsi+ is a little (usually 0.5 or so) larger than \verb+QpGcutUUUUUUcou+.
     It becomes accurate if we use large \verb+QpGcutUUUUUUcou+. 
     But it enlarge size of IPW(interstitial plane wave) part of Mixed
     product basis. For test, try  2.7, 3.2, 3.7 for \verb+QGcutUUUUUUcou+
     (and add 0.5 or 1 for \verb+QGcutUUUUUUpsi+). Larger one is expensive.\\
...
\keyw{emax\UUUUUUchi0}: 1 real (optional,default=$\infty$), in Ry\\

\keyw{emax\UUUUUUsigm}: 1 real (optional,default=$\infty$; We usually use 3 Ry).\\
\verb+emaxUUUUUUsigm+ is the maximum limit of the self-energy 
(measured from the Fermi energy). See the paper \cite{xxx} which shows
how the results are affected by {\tt emax\UUUUUUsigm}.
But in cases, small \verb+emaxUUUUUUsigm+ can give poor dispersion curve
(slightly unnatural behavior) because of sudden cutoff by emax\UUUUUUsigm.
...
{\tt emax\UUUUUUsigm}, as shown in \cite{xxx}, ). 
...
\keyw{nband\UUUUUUchi0}: 1 integer (optional,default=$\infty$)\\
\keyw{nband\UUUUUUsigm}: 1 integer (optional,default=$\infty$)\\
...
\keyw{HistBin\UUUUUUdw}  : 1 real (a.u.). Mesh width along real axis for $W(\omega)$.\\
\keyw{HistBin\UUUUUUratio} : 1 real (a.u.). \\
\verb+HistBinUUUUUUdw+ and \verb+HistBinUUUUUUratio+ specify real 
space bins which we accumulate imaginary part
weight of polarization functions.
The bins are (see \verb+frhis+ in \verb+ecalj/fpgw/gwsc/mUUUUUUfreq.F+)
\begin{eqnarray}
\omegaUUUUUUi=b*(\exp(a*(i-1))-1),
\end{eqnarray}
where $[\omegaUUUUUUi, \omegaUUUUUU(i+1)]$ ($i=1,2,...,$\verb@nwhis+1@) is the $i$-th bin.
\verb+HistBinUUUUUUdw+ is bin width at
$\omega=0$. The ratio $\omegaUUUUUU(i+1)/\omegaUUUUUU(i)$ for large $\omega$ is
$\exp(a)$=\verb+HistBinUUUUUUratio+.
...
sensitive to the choice of \verb+HistBinUUUUUUdw, HistBinUUUUUUratio+ 
...
averaged in the $\Gamma$-cell \cite{kotaniUUUUUUformulationUUUUUU2015}. 
And $\bar{W(\omega}$ get closer to $v$ for larger $\omega$.

Default value of them are given in \verb+fpgw/gwsrc/mUUUUUUfreq.F+.
They are
\begin{verbatim}
 call getkeyvalue("GWinput","HistBinUUUUUUratio",oratio, default=1.03d0) 
 call getkeyvalue("GWinput","HistBinUUUUUUdw",dw, default=1d-5) !a.u.
\end{verbatim}
These are safer settings. Thus new \verb+mkGWINUUUUUUlmf2+ (GWinput.tmp
generator) gives default lines in \verb+GWinput+ as
\begin{verbatim}
HistBinUUUUUUdw  2d-3 ! 1d-5 for metal  !(a.u.) bin width along real axis at omega=0.
HistBinUUUUUUratio 1.08 ! 1.03 for check. frhis(iw)= b*(exp(a*(iw-1))-1),
...
\keyw{omg\UUUUUUc} : 1 real (a.u.). \\
{\tt dw} and {\tt omg\UUUUUUc}
...
%But {\tt omg\UUUUUUc} is not used in gw\UUUUUUlmf; then energy mesh is fixed as {\tt dw}.
...
%to determine $W(\omega'=\omega-\epsilonUUUUUU{{\bf q-k}n})$. See FIG.1 in Ref.I.


\vspace{2mm}
\keyw{delta}: 1 real (a.u.). We usually use very small number as -1d-8
for gw\UUUUUUlmfh, eps mode and so.\\
...
In gw\UUUUUUlmf, it is used for broadening of x0 when it call hx0fp0.
...
{\tt Q0P\UUUUUUChoice} gives how to determine the offset gamma points.
...
\keyw{alpha\UUUUUUoffG}: 1 real (a.u.) \\
{\tt alpha\UUUUUUoffG} corresponds to $\alpha$ in EQ.48.
{\tt alpha\UUUUUUoffG}=1d0 is usually good in the sense that
it seems to be almost a limit at $\alpha \to 0$.
So you can usually fix it as {\tt alpha\UUUUUUoffG}=1d0, and check the
...
% you have to use larger {\tt QpGcut\UUUUUUpsi}.). \\
...
(how we determine $VUUUUUU{\rm xc}$ from calculated $\Sigma(\omega)$).
We now mostly use {\tt iSigMode}=3. 

3:\ Use $\ds {\rm Re}\frac{\SigmaUUUUUU{nn'}(\epsilonUUUUUUn)+\SigmaUUUUUU{nn'}(\epsilonUUUUUU{n'})}{2}$
  (mode-A in \cite{xxx}).

1:\ Use $\ds \SigmaUUUUUU{nn'}(EUUUUUUF) + \deltaUUUUUU{nn'}(\SigmaUUUUUU{nn'}(\epsilonUUUUUUn)-\SigmaUUUUUU{nn'}(EUUUUUUF))$
   (mode-B in \cite{xxx}).

5:\ Use $\ds \deltaUUUUUU{nn'} \SigmaUUUUUU{nn}(\epsilonUUUUUUn)$ (Eigenvalue-only
      self-consistency, keeping the eigenfuncions as given)).

See \verb@/gwsrc/sxcfUUUUUUfal2.sc.F@, which is called from the main routine
      \exe{hsfp0\UUUUUUsc} (this is the routine to calculate self-energy)).
...
so its hsfp0\UUUUUUsc part is quite expensive (usually it takes time more than hx0fp0).

 \

\noindent Additional Note --------------\\

\noindent \keyw{QPNT\UUUUUUnbandrange} num1 num2 (two integers).\\
...
For eps modes (scripts \verb@epsUUUUUU*@, which are for linear responses. 
See Sec.\ref{linearr}),
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\fx{$<$PRODUCT\UUUUUUBASIS$>$ section} 
...
Look into LMTO file (generated by {\bf mkGWIN\UUUUUUlmf2}); 
...
{\sf GWinput.tmp} generated by {\bf mkGWIN\UUUUUUlmf2} contains
labels on each orbitals as \verb@4SUUUUUUp@, \verb@4SUUUUUUd@, \verb@4PUUUUUUp@...
Here \verb@4SUUUUUUp@ is for $\phiUUUUUU{4s}$; \verb@4SUUUUUUd@ for $\dot{\phi}UUUUUU{4s}$;
\verb@3DUUUUUUl@ for $\phi^{\rm local}UUUUUU{3d}$. 
...
In this sample {\sf GWIN\UUUUUUV2} as for atom 1,
$\{ \phiUUUUUU{4s},\dot{\phi}UUUUUU{4s},\phiUUUUUU{4p},\phiUUUUUU{4d},\phi^{\rm local}UUUUUU{3d}, 
\phi^{\rm core}UUUUUU{3s},\phi^{\rm core}UUUUUU{3p} \}$
consist the group \verb@occ@, and
$\{ \phiUUUUUU{4s},\phiUUUUUU{4p},\phiUUUUUU{4d},\phi^{\rm local}UUUUUU{3d},\phiUUUUUU{4f} \}$
consists the group  \verb@unocc@.
So the any product of combinations
$\{ \phiUUUUUU{4s},\dot{\phi}UUUUUU{4s},\phiUUUUUU{4p},\phiUUUUUU{4d},\phi^{\rm local}UUUUUU{3d}, 
\phi^{\rm core}UUUUUU{3s},\phi^{\rm core}UUUUUU{3p} \}
\times \{ \phiUUUUUU{4s},\phiUUUUUU{4p},\phiUUUUUU{4d},\phi^{\rm local}UUUUUU{3d},\phiUUUUUU{4f} \}$
are included as for the basis of the product basis.
As for atom 2,
$\{ \phiUUUUUU{2s},\phiUUUUUU{2p},\phiUUUUUU{3d} \} 
\times \{ \phiUUUUUU{2s},\phiUUUUUU{2p},\phiUUUUUU{3d},\phiUUUUUU{4f} \}$
are included.
...
\item
     ...
     Need to repeat mkGWIN\UUUUUUlmf2 to generate GWinput template when you
     add PZ (local orbital).
\end{itemize}

%As for the case of {\bf gwnc\UUUUUU{\it foo}}, this section is neglected.
\begin{quote}
...
\exe{gw\UUUUUUlmfh} (essentially as same as \exe{gw\UUUUUUlmf}).
\begin{itemize}
\item 
...
$\SigmaUUUUUU{\rm x}$ only due to the \raw{C}=0 cores are calculated.
...
$\SigmaUUUUUU{\rm x}$ due to valence and due to \raw{C}=1 cores
are calculated.
...
Only see the switch \raw{C}.
$\SigmaUUUUUU{\rm c}$ due to valence and due to \raw{C}=1 are calculated.

\end{itemize}

\end{quote}

\noindent $\bullet$ After you perform \verb@gwUUUUUUlmfh@ or anything,
...
Product basis B({\bf r}-{\bf a}) is translated to B({\bf r}-{\bf a}-Af})= B({\bf r}-{\bf a}'-TUUUUUU0})
...
In the case of one-shot GW (gw\UUUUUUlmf and gw\UUUUUUlmfh),
...
An example of one-shot GW by \exe{gw\UUUUUUlmfh}) is 
...
\begin{verbatim} 
 ...
 ===============================================================
EUUUUUUshift=  0.4263273221017709D+00  0.6075150850568627D+00  0.7046628446164018D+00 eV
...
This {\tt eLDA - E\UUUUUUshift} are the eigenvalues relative to a Fermi energy determined by the smearing method.
Detailed value of {\tt eLDA} is in {\sf TOTE2.UP}.
Detailed value of {\tt eLDA- E\UUUUUUshift} is in {\sf TOTE.UP}.
...
{\tt SEx}: = $= \langle\PsiUUUUUU{{\bf k}n}|\SigmaUUUUUU{\rm x}^{\rm core2+valence}({\bf r},{\bf r}^{\prime})|\PsiUUUUUU{{\bf k}n}\rangle$

{\tt SExcore}: $= \langle\PsiUUUUUU{{\bf k}n}|\SigmaUUUUUU{\rm x}^{\rm core1}({\bf r},{\bf r}^{\prime})|\PsiUUUUUU{{\bf k}n}\rangle$

{\tt SEc}: $ = \langle\PsiUUUUUU{{\bf k}n}|\SigmaUUUUUU{\rm c}^{\rm core2+valence}({\bf r},{\bf r}^{\prime},\epsilonUUUUUUn({\bf k}))|\PsiUUUUUU{{\bf k}n}\rangle$

{\tt vxc}: LDA exchange correlation energy.
$\langle\PsiUUUUUU{{\bf k}n}|VUUUUUU{\rm xc}^{\rm LDA}([nUUUUUU{\rm total}],{\bf r})|\PsiUUUUUU{{\bf k}n}\rangle$

{\tt dSE}: $ZUUUUUU{n{\bf k}}\times$ {\tt dSEnoZ}

{\tt dSEnoZ}: $
\langle\PsiUUUUUU{{\bf k}n}|
\SigmaUUUUUU{\rm x}^{\rm core1}({\bf r},{\bf r}^{\prime})+
\SigmaUUUUUU{\rm xc}^{\rm core2+valence}({\bf r},{\bf r}^{\prime},\epsilonUUUUUUn({\bf k}))
|\PsiUUUUUU{{\bf k}n}\rangle 
- \langle\PsiUUUUUU{{\bf k}n}|VUUUUUU{\rm xc}^{\rm LDA}([nUUUUUU{\rm total}],{\bf r})|\PsiUUUUUU{{\bf k}n}\rangle$

\hspace{1cm} = {\tt SEx + SExcore + SEc - vxc}

{\tt eLDA}: LDA eigenvalues. $\epsilonUUUUUUn({\bf k})$

{\tt eQP}: QP energy.  $\epsilonUUUUUUn({\bf k})$+{\tt dSE}

{\tt eQPnoZ}: QP energy without $Z$. $\epsilonUUUUUUn({\bf k})$+{\tt dSEnoZ}

{\tt eHF}: HF energy of 1st iteration. $\epsilonUUUUUUn({\bf k})$+{\tt SEx + SExcore -vxc}

{\tt Z}: Z factor. $ZUUUUUU{n{\bf k}}$

{\tt 2Z*Simg}: Quasi-particle life time. 
$2 ZUUUUUU{n{\bf k}} \times {\rm Im}
\langle\PsiUUUUUU{{\bf k}n}|
...
and three energy shifts {\tt E\UUUUUUshift}, which are the same values in the 4th line of {\sf QPU}.
...
\fx{Core\UUUUUUibas*\UUUUUUl*.chk}
Used core eigenfunctions.

\fx{VXCFP.chk}
This contains eigenvalues and 
$\langle \psiUUUUUU{\bfk n} |VUUUUUU{\rm xc} |\psiUUUUUU{\bfk n}\rangle$
...
We mainly have two kinds of Fermi energy $EUUUUUU{\rm FEERMI}^{\rm smear}$ 
$EUUUUUU{\rm FEERMI}^{\rm tetra}$.
...
$EUUUUUU{\rm FEERMI}^{\rm smear}$ which is determined by the smearing method.
It is also shown at the top part of output files \io{lsx\UUUUUUsf} and \io{lsc\UUUUUUsf}.
...
Here $EUUUUUU{\rm FEERMI}^{\rm smear}$=8.520283353474250E-003. 
From the second lines, they are LDA eigenvalues and QP energies 
(Z included and Z=1); they are relative to the $EUUUUUU{\rm FEERMI}^{\rm smear}$.\\
-13.18843159 eV - $EUUUUUU{\rm FEERMI}^{\rm smear}$(which should be translated into in eV)  
= -0.1330435686590073D+02 eV.
Here -13.18843159 is the value in \io{VXCFP.chk} shown above.


\item
There is the another Fermi energy $EUUUUUU{\rm FEERMI}^{\rm tetra}$, 
which is used by mode 11 (or mode 1) of hx0fp0 in {\bf gw\UUUUUUlmfh}.
...
..
\end{verbatim}}
,where a number in first line $EUUUUUU{\rm FEERMI}^{\rm smear}$= 
...
As for {\bf gwband\UUUUUUlmf}, it recalculates eigenvalues for all \bfq \ along SYML.
Then\\ the default "zerolevel" = $EUUUUUU{\rm FEERMI}^{\rm smear}$ - eshift(lda). 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section{mkGWIN\UUUUUUlmf2 and its I/O Files}
(QPNT.chk contains irreducible k
point for given n1 n2 n3; KPTin1BZ.gwinit.chk contain all k points in
Brillouin Zone).

The purpose of the script {\bf mkGWIN\UUUUUUlmf2} is to give a template \io{GWinput.tmp}.
...
This file is given within the script of mkGWIN\UUUUUUlmf2 (as "here document").
{\baselineskip=2.8mm
\begin{verbatim}
cat <<EOF >GWIN0
n1 n2 n3
...
($pUUUUUU{\rm valence}, l, a$ ) for orbitals in the MT.
($pUUUUUU{\rm valence}$ is radial function index, 
$a$ is atomic site index). Eigenfunctions are expanded in this order.
}

\fl{ldima}
Number of MTOs for each atomic site.
(this is used only from \exe{hqpe\UUUUUUsc}---QSGW mode).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5
\ssx{gwinit} --- Get GWIN\UUUUUUV2.tmp and QPNT.tmp
...
\fl{GWIN\UUUUUUV2.tmp}  A part of GWinput.tmp
...
Note that \io{LATTC SYMOPS CLASS NLAindx} are overwritten when you execute {\bf gw\UUUUUUlmfh}
because we repeat {\bf echo~0$|$lmf} at the head of {\bf gw\UUUUUUlmfh}.
...
\fl{GWIN\UUUUUUV2} (copy of \io{GWIN\UUUUUUV2.tmp} by {\bf gwinit})
...
(\exe{mkGIN\UUUUUUlmf} keeps \io{GWinput} if it exist before you invoke it.).
...
\begin{verbatim}
 ...
 NOUUUUUUMPI=0 #this is used for non-mpi versions of fortran program.

 ### self-consistent calculation for given Sigma(self-energy) ###

          runUUUUUUarg '---' $MPIUUUUUUSIZE $nfpgw   /lmf-MPIK    llmf $TARGET


 ### Preparation stage ##############################################

 argin=0;  runUUUUUUarg $argin $NOUUUUUUMPI  $nfpgw   /lmfgw      llmfgw00 $TARGET 
 argin=1;  runUUUUUUarg $argin $NOUUUUUUMPI  $nfpgw   /qg4gw      lqg4gw   #Generate requied q+G v
 argin=1;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw  /lmfgw-MPIK llmfgw01 $TARGET
           runUUUUUUarg  '---' $NOUUUUUUMPI   $nfpgw  /lmf2gw     llmf2gw  #reform data for gw

 ### Main stage of gw ################################################

 argin=0;  runUUUUUUarg $argin $NOUUUUUUMPI   $nfpgw  /rdata4gwUUUUUUv2 lrdata4gwUUUUUUv2 #prepare files
 argin=1;  runUUUUUUarg $argin $NOUUUUUUMPI $nfpgw    /heftet      leftet # A file EFERMI for hx0fp0
 argin=1;  runUUUUUUarg $argin $NOUUUUUUMPI $nfpgw    /hchknw      lchknw # A file NW, containing nw 

  ## Core part of the self-energy (exchange only) ##

  argin=3;  runUUUUUUarg $argin $NOUUUUUUMPI $nfpgw    /hbasfp0    lbasC # Product basis generation 
  argin=3;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw  /hvccfp0    lvccC # Coulomb matrix for lbasC 
  argin=3;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw  /hsfp0UUUUUUsc   lsxC  # Sigma from core1


  ## Valence part of the self-energy Sigma ##

  argin=0;  runUUUUUUarg $argin $NOUUUUUUMPI $nfpgw   /hbasfp0     lbas # Product basis generation 
  argin=0;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw /hvccfp0     lvcc # Coulomb matrix for lbas 
  argin=1;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw /hsfp0UUUUUUsc    lsx  # Exchange Sigma
  argin=11; runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw /hx0fp0UUUUUUsc   lx0 $lx0UUUUUUparaUUUUUUoption #x0 part
  argin=2;  runUUUUUUarg $argin $MPIUUUUUUSIZE $nfpgw /hsfp0UUUUUUsc    lsc  #correlation Sigma
  argin=0;  runUUUUUUarg $argin $NOUUUUUUMPI $nfpgw   /hqpeUUUUUUsc     lqpe #all Sigma are combined.
...
Here a subroutine of bash {\bf run\UUUUUUarg} was used, which is given in \io{ecalj/lm7K};
...
\end{quote}
invokes \exe{hsfp0\UUUUUUsc} with argument '2' by mpirun with the -np
\$MPI\UUUUUUSIZE. Console outputs are written into logfiles such as \io{lqpe}.
...
See e.g. \raw{main/hx0fp0.sc.F} and search "\raw{call read\UUUUUUBZDATA}",
...
and $\langle \psi | HUUUUUU{\rm KS}|\psi\rangle$
...
\fl{gw1.si}(bin) $\langle \psi|HUUUUUU{\rm KS}|\psi \rangle$ 

\fl{gw2.si}(bin) $\langle \psi|HUUUUUU{\rm KS}-VUUUUUU{\rm xc}(nUUUUUU{\rm total})|\psi \rangle$.

\fl{vxc.si,evec.si}(bin) used in hqpe.sc.m.f as "v\UUUUUUxc" and "evec").\\
\io{vxc.si} contains 
$\langle \psi|VUUUUUU{\rm xc}(nUUUUUU{\rm total})|\psi \rangle$ including off-diagonal part.
...
...
\end{verbatim}}
This check is sometimes important for debugging and to determine the cutoff parameter \keyw{QGcut\UUUUUUpsi}.
...
You can see that it get closer to unity for larger QGcut\UUUUUUpsi, 
...
%----------------------------------------------------
\ssx{lmf2gw} All the required information are stored into \io{DATA4GW\UUUUUUV2} and \io{CphiGeig}.
...
\fl{DATA4GW\UUUUUUV2} (bin) Main data for GW calculations. 

I/O of {\sf DATA4GW\UUUUUUV2} is controlled by {\tt gwinput.f}, which 
...
\end{center}
% \section{Executions and their I/O Files: in Main stage of gw\UUUUUU{\it foo}}
...
\ssx{rdata4gw\UUUUUUv2}--- Read \io{DATA4GW\UUUUUUV2} and some files, and decompose it into files required in
...
\fl{Core\UUUUUUibas*\UUUUUUl*.chk} core eigenfunctions just for check.
...
\fl{@MNLA\UUUUUUCPHI} index set for {\sf CPHI}. This is not refereed just a check write.

\fl{@MNLA\UUUUUUcore} index set for core. This is not refereed just a check write.

\fl{VXCFP} (bin) this is for diagonal elements of $V^{\rm LDA}UUUUUU{\rm xc}(nUUUUUU{\rm total})$. 
%(the script {\tt gw\UUUUUU{\it foo}} case).
%{\sf VXCFPV} is for $V^{\rm LDA}UUUUUU{\rm xc}(nUUUUUU{\rm valence})$ with NoCore case (the script {\tt gwnc\UUUUUU{\it foo}} ).
...
This \io{NW} is not essentially used in \exe{gw\UUUUUUlmfh} (but required as a dummy file). 
Only used in \exe{gw\UUUUUUlmf}.
...
\fl{PPBRD\UUUUUUV2\UUUUUU*}(bin) Radial integrals on each MT, symbolically written as 
...
\fl{GWinput, LMTO, ECORE, SYMOPS} These are readin by \raw{genallcf\UUUUUUv3}.
...
\keyw{emax\UUUUUUchi0}, \keyw{emax\UUUUUUsigm},\keyw{nband\UUUUUUchi0}, and
\keyw{nband\UUUUUUsigm}. But we usually unset them except 
\keyw{emax\UUUUUUsigm} for \exe{gwsc}.
...
-------------
\item 
\keyw{QpGcut\UUUUUUpsi} IPW cutoff to expand eigenfuncitons in the
      interstitial region. We usually use \verb@QpGcut\UUUUUUpsi 4.0@.
      Usually not so bad. Larger is better but expensive. You may test 
      calculations with \verb@QpGcut\UUUUUUpsi 3.0@, and how much difference
      of results.

\item 
\keyw{QpGcut\UUUUUUcou} IPW cutoff to expand the Coulomb interaction 
     in the interstitial region (Mixed product basis(MPB) consist of this IPW and PB).
      interstitial region. We usually use \verb@QpGcut\UUUUUUcou 3.0@.
      Usually not so bad. Larger is better but expensive. You may test 
      calculations with \verb@QpGcut\UUUUUUcou 2.5@, and how much difference
      of results.
...
But usually \verb@dw=0.005, omgUUUUUUc=0.04@ is not so bad a choice.
...
``chi\UUUUUUregqbz off'' may accelerate convergence on number of k points.
...
\item \raw{(This is old mode --- not maintained) epsPP\UUUUUUlmfh\UUUUUUchipm\UUUUUUq}
...
transformation method); we first calculate its imaginary parts
  ...
  You need to choose \keyw{HisBin\UUUUUUdw,HisBin\UUUUUUratio}. 
  The width of histogram bins are getting larger when omega gets larger.
  dw is the size of histogram-bin width at omega=0. 
  At omega=omg\UUUUUUc, its width gets twiced.

  To plot dielectric function with reasonable resolution, it might be
  better to set \verb@dw 0.001@ and \verb@omgUUUUUUc 0.1@ for example.
  You may have to choose small enough omega 
  for spin wave mode as 0.001 Ry (Or smaller).
  omg\UUUUUUc is given like 0.05 Ry or so. But sometimes it can be like 1Ry.

  
\noindent $\bullet$ \raw{epsPP\UUUUUUlmfh} only calculation an matrix element 
  of dielectric funciton for $exp(i \bfq \bfr)$. Thus very faster 
  than \raw{eps\UUUUUUlmfh} mode. 
...
%\noindent $\bullet$ \keyw{EPSrange, EPSdw} are not used for \verb@*UUUUUUlmfhUUUUUU*@ scripts.


\begin{verbatim}
In *UUUUUUlmfhUUUUUU* modes( I now use little for *UUUUUUlmfUUUUUU* modes), you can use small enough delta.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{eps\UUUUUUlmfh, epsPP\UUUUUUlmfh: the dielectric functions}

You can invoke the script, e.g. as "\exe{eps\UUUUUUlmfh} \ si".

----------------

Specify ${\bf q}$ point in \verb@<QforEPS>@ or so.
Mesh for $\omega$ is specified by \keyw{dw, omg\UUUUUUc}.
...
(this is generated only for \verb@epsUUUUUUlmfh@. Both of them contains
...
See section for \exe{eps\UUUUUUPP\UUUUUUlmfh}.
...
by this option. Try to plot \io{Core\UUUUUU*.chk} files, 
...
%%%%%%%%%%%%%%%%%
\subsection{epsPP\UUUUUUlmfh: the dielectric function(No LFC--- faster)}

You can calculate $\epsilon$ without LFC by
{\bf epsPP\UUUUUUlmfh}. It is very faster than \exe{eps\UUUUUUlmfh}.
...
%You can test it by the script {\bf epsPtestNoLfc\UUUUUUnfp}. 
%Please check the script whether it sets the {\bf q}
%point which you want to calculate.
%{\bf epsPtestNoLfc\UUUUUUnfp} runs \verb@echo 3|hsfp0@. 
%The mode 3 only gives files {\sf  EPSxx.nolfc.dat}.
%
%Apparently you don't needs to do {\bf eps\UUUUUUlmf} if you just change the file
%{\sf EPS\UUUUUUcond}; then you just need to run \verb@echo 4|hsfp0@.
...
At first, we talk about epsPPUUUUUUlmfh, which is No LFC. Main problem are 
...
1.Convergence for number of k point(specified by n1n2n3). 
  ...
  figs are for GaAs.
  fig001: n1n2n3 convergence for ChiUUUUUURegQbz = on  case.
  fig002: n1n2n3 convergence for ChiUUUUUURegQbz = off case.
  (ChiUUUUUURegQbz in explained in General section in this manual).

  As you see, k points convergence looks a little better in ChiUUUUUURegQbz=off
  (mesh not including gamma). However a little ploblem is that its thereshold around 
  0.5eV is too high and slowly changing.

  fig003: Alouanis'(from Arnaud)  vs. ``ChiUUUUUURegQbz = on'' vs. ``ChiUUUUUURegQbz = off''
  As you see, the threshold of the Red line (20x20x20 ChiUUUUUURegQbz=on) and Alouani's 
  are almost the same, but the red line is too oscilating at the low energy part.
  On the other hand, ``ChiUUUUUURegQbz = off'' in Green broken line is not so satisfactory
  at the low energy part. 

  fig.gasUUUUUUepsUUUUUUkconf.pdf shows the convergence behevior of epsilon for 
  
   
2.$q \to 0$ convergence (this is related to whether ChiUUUUUURegQbz=on or off).
  ...
  ehough.
  In fig.gasUUUUUUepsUUUUUUqconv.jpg, we checked the convergence of eps (\omega=0,q) for q \to 0.
...
4. basis set.
   Use QpGcutUUUUUUpsi \approx 3.0 a.u. or so (as same as GW calculation).
   In the case of epsPP* mode, 
   QpGcutUUUUUUcou can be very small--- In our codes now, 
...
-- epsUUUUUUlmfh: including LFC ----------------------------------
To include eps with LFC, do epsUUUUUUlmfh. 
...
Further you can use smaller QpGcutUUUUUUcou like 2.2 or so, 
with rather smaller product basis (up to p timed d, not including f).

Note: epsPPUUUUUUlmfh is designed to use good basis to calculate eps 
without LFC. This is usually in agreement with what you obtained by epsUUUUUUlmfh;
...
1. set q=0.02 [q=2pi/alat(0 0 0.02)] or so for GaAs case.
   ...
   ``ChiUUUUUURegQbz = off'' is better for matrials like GaAs with direct gap.

2. You can use small QpGcutUUUUUUcou but all ngc should be one or more.
...
3. As for the Product basis setting in epsPP* scripts, only
   ...
   5. To get eps with LFC, set QpGcutUUUUUUcut as xxx, and set lcutmx=2 where
   4. Do nk=20 18 16 and take interpolarion 

   (occupied sp) \timex (unoccupied spd) are included.
   But correct EPS*.nolfc.d is rather from epsPPUUUUUUlmfh script.

\end{verbatim}


\figp{gasUUUUUUfig001.eps}

fig001

\figp{gasUUUUUUfig002.eps}

fig002

%\begin{center}
\figp{gasUUUUUUfig003.eps}

fig003


\figp{gasUUUUUUfig004.eps}\\
fig004

\figp{gasUUUUUUfig005.eps}\\
fig005

\figp{gasUUUUUUfig007.eps}\\
fig007

\figp{gasUUUUUUfig008.eps}\\
fig008
...
{\bf cif to PROCAR}
\begin{verbatim}
./cif2cell --vasp-cartesian --vasp-format=5 cifs/BaTiO3UUUUUUcubic.cif 
\end{verbatim}
